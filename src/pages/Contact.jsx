...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:hello@celure.in?subject=${subject}&body=${body}`;
    setSent(true);
  };
      ...
      <div className="max-w-lg mx-auto pt-12">
        ...
        <a href="mailto:hello@celure.in"
          ...
          <div>
            ...
            <p className="text-white text-sm font-medium">hello@celure.in</p>
          </div>
        </a>

        {/* Instagram */}
        <a href="https://instagram.com/celure.in" target="_blank" rel="noopener noreferrer"
          ...
          <div>
            ...
            <p className="text-white text-sm font-medium">@celure.in</p>
          </div>
        </a>
